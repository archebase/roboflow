...
- **LeRobot Integration**: Convert robotics datasets to LeRobot format for robotics learning
...
- `lerobot-hdf5` - LeRobot HDF5 dataset support
- `lerobot-parquet` - LeRobot Parquet dataset support
- `lerobot-all` - All LeRobot features
...
- [Documentation](https://github.com/archebase/robocodec/wiki)
