...
use crate::video::frame::{VideoEncoderError, VideoFrameBuffer};
...
///
/// ```rust,ignore
/// use crate::video::{RsmpegMp4Encoder, VideoEncoderConfig, VideoFrameBuffer};
///
...
impl PersistentEncoder {
    ...
    fn copy_nv12_frame_data(
        frame: &crate::video::frame::VideoFrame,
