...
use crate::media::video::fragment::{FragmentEncoder, FragmentEncoderConfig, FragmentInfo};
use crate::media::video::frame::VideoFrame;
use crate::media::video::simd::{ConversionStrategy, optimal_strategy};
...
impl EncodeCommand {
    ...
    pub fn from_decoded(
        ...
        let frames = match crate::media::video::simd::rgb_batch_to_nv12(
            &rgb_data,
            width_usize,
            height_usize,
        ) {
            ...
            Err(_) => {
                ...
                decoded_frames
                    .into_iter()
                    .map(|f| {
                        match crate::media::video::simd::rgb_to_nv12(
                            f.data(),
                            width_usize,
                            height_usize,
                        ) {
