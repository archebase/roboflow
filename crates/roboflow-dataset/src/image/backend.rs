...
use super::{format::ImageFormat, memory::MemoryStrategy, ImageError, Result};
...
mod tests {
    ...
    fn test_should_use_gpu() {
        ...
        let small = DecodedImage::new(320, 240, vec
![0u8; 320 * 240 * 3]);
        assert!(!small.should_use_gpu());

        // Large image - GPU is worth it
        let large = DecodedImage::new(640, 480, vec
![0u8; 640 * 480 * 3]);
    ...
    fn test_decode_jpeg_basic() {
        ...
        let jpeg_data = [
            ...
            0x01, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0xFF, 0xDB, 0x00,
            0x43, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x0A, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x00, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A,
            0x0B, 0xFF, 0xC4, 0x00, 0x14, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x09, 0xFF, 0xC4, 0x00, 0x14, 0x10, 0x01, 0x00, 0x00, 0x00,
