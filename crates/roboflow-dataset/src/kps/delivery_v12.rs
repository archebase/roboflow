...
use crate::kps::{KpsConfig, RobotCalibration};
...
impl TaskStatistics {
    ...
    ///
    /// Note: HDF5 support has been moved to roboflow-hdf5 crate.
    /// This function now returns 0 as a placeholder.
    fn extract_frame_count_from_hdf5(_path: &Path) -> Result<usize, Box<dyn std::error::Error>> {
        // HDF5 is now in a separate crate
        Ok(0)
    }
