...
impl StreamingParquetWriter {
    ...
    fn write_parquet_shard(&mut self) -> roboflow_core::Result<()> {
        use polars::prelude::*;
    ...
    fn write_metadata_files(&self, config: &KpsConfig) -> roboflow_core::Result<()> {
        use crate::kps::info;
        ...
        .map_err(|e| roboflow_core::RoboflowError::parse("Parquet", e.to_string()))?;
