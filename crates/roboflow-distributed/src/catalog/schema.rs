...
pub type Result<T> = std::result::Result<T, roboflow_core::RoboflowError>;
...
impl EpisodeMetadata {
    ...
    pub fn encode(&self) -> Result<Vec<u8>> {
        bincode::serialize(self).map_err(|e| {
            roboflow_core::RoboflowError::other(format!("Failed to encode episode metadata: {}", e))
        })
    }
    ...
    pub fn decode(data: &[u8]) -> Result<Self> {
        bincode::deserialize(data).map_err(|e| {
            roboflow_core::RoboflowError::other(format!("Failed to decode episode metadata: {}", e))
        })
    }
}
...
impl SegmentMetaData {
    ...
    pub fn encode(&self) -> Result<Vec<u8>> {
        bincode::serialize(self).map_err(|e| {
            roboflow_core::RoboflowError::other(format!("Failed to encode segment metadata: {}", e))
        })
    }
    ...
    pub fn decode(data: &[u8]) -> Result<Self> {
        bincode::deserialize(data).map_err(|e| {
            roboflow_core::RoboflowError::other(format!("Failed to decode segment metadata: {}", e))
        })
    }
}
...
impl UploadStatus {
    ...
    pub fn encode(&self) -> Result<Vec<u8>> {
        bincode::serialize(self).map_err(|e| {
            roboflow_core::RoboflowError::other(format!("Failed to encode upload status: {}", e))
        })
    }
    ...
    pub fn decode(data: &[u8]) -> Result<Self> {
        bincode::deserialize(data).map_err(|e| {
            roboflow_core::RoboflowError::other(format!("Failed to decode upload status: {}", e))
        })
    }
}
...
mod tests {
    ...
    fn test_episode_metadata_new() {
        let episode =
            EpisodeMetadata::new("ep-1", "test-dataset", 100, 1024 * 1024, 0, 1_000_000_000);
