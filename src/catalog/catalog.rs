...
use crate::catalog::{
    config::TiKVConfig,
    key::{EpisodeKey, SegmentKey, UploadKey},
    pool::TiKVPool,
    schema::{EpisodeMetadata, SegmentMetaData, UploadStatus},
};
...
impl TiKVCatalog {
    ...
    pub async fn new(config: TiKVConfig) -> Result<Self, crate::RoboflowError> {
    ...
    pub async fn register_episode(&self, episode: EpisodeMetadata) -> Result<(), crate::RoboflowError> {
    ...
    pub async fn get_episode(&self, episode_id: &str) -> Result<Option<EpisodeMetadata>, crate::RoboflowError> {
    ...
    pub async fn episode_exists(&self, episode_id: &str) -> Result<bool, crate::RoboflowError> {
        let key = EpisodeKey::metadata(episode_id);
        Ok(self.pool.get(key).await?.is_some())
    }

    /// Update episode metadata.
    pub async fn update_episode(&self, episode: EpisodeMetadata) -> Result<(), crate::RoboflowError> {
        let key = EpisodeKey::metadata(&episode.episode_id);
        let value = episode.encode()?;
    ...
    pub async fn delete_episode(&self, episode_id: &str) -> Result<(), crate::RoboflowError> {
        let key = EpisodeKey::metadata(episode_id);
    ...
    pub async fn get_segment(&self, segment_id: &str) -> Result<Option<SegmentMetaData>, crate::RoboflowError> {
    ...
    pub async fn get_segment_by_config(
        &self,
        config_hash: &str,
    ) -> Result<Option<SegmentMetaData>, crate::RoboflowError> {
    ...
    pub async fn update_segment(&self, segment: SegmentMetaData) -> Result<(), crate::RoboflowError> {
        let key = SegmentKey::metadata(&segment.segment_id);
        let value = segment.encode()?;
    ...
    pub async fn delete_segment(&self, segment_id: &str) -> Result<(), crate::RoboflowError> {
    ...
    pub async fn set_upload_status(&self, status: UploadStatus) -> Result<(), crate::RoboflowError> {
    ...
    pub async fn get_upload_status(&self, episode_id: &str) -> Result<Option<UploadStatus>, crate::RoboflowError> {
    ...
    pub async fn delete_upload_status(&self, episode_id: &str) -> Result<(), crate::RoboflowError> {
        let key = UploadKey::status(episode_id);
        self.pool.delete(key).await?;
    ...
    pub async fn health_check(&self) -> Result<(), crate::RoboflowError> {
