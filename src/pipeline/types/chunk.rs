...
pub struct MessageChunk<'arena> {
    ...
    pub arena: *mut crate::pipeline::types::arena::MessageArena,
...
impl<'arena> MessageChunk<'arena> {
    ...
    pub fn new(sequence: u64) -> Self {
        ...
        let arena = Box::new(crate::pipeline::types::arena::MessageArena::new());
        let arena_ptr = Box::leak(arena) as *mut crate::pipeline::types::arena::MessageArena;
    ...
    pub fn with_pooled_arena(sequence: u64, mut pooled_arena: PooledArena) -> Self {
        let arena_ptr =
            pooled_arena.arena_mut() as *mut crate::pipeline::types::arena::MessageArena;
