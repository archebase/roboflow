...
impl Hdf5KpsWriter {
    ...
    fn write_from_mcap_impl(
        ...
        for result in reader.decode_messages()? {
            ...
            match &mapping.mapping_type {
                crate::dataset::kps::config::MappingType::Image => {
                    self.buffer_image_data(mapping, &msg)?;
                }
                crate::dataset::kps::config::MappingType::State
                | crate::dataset::kps::config::MappingType::Action => {
    ...
    fn write_buffered_images(
        ...
        for (name, images) in &self.image_buffers {
            ...
            let dataset = group
                ...
                .create(&**name)
                .map_err(|e| {
                    crate::dataset::kps::writers::base::KpsWriterError::Hdf5(e.to_string())
                })?;
    ...
    fn write_metadata(
        ...
        for (key, value) in metadata {
            ...
            group.attr(key)?.write(&value).map_err(|e| {
                crate::dataset::kps::writers::base::KpsWriterError::Hdf5(e.to_string())
            })?;
        }
