...
//! ```no_run
//! # fn main() {
//! use robocodec::transform::{TopicRenameTransform, TransformPipeline};
//!
...
impl ChannelInfo {
    ...
    pub fn from_reader_info(info: &crate::format::reader::ChannelInfo) -> Self {
        Self {
            id: info.id,
...
pub trait McapTransform: Send + Sync + 'static {
    ...
    ///
    /// This enables cloning of `TransformPipeline` which contains
...
impl TransformBuilder {
    ...
    /// Build a TransformPipeline from this builder.
