...
impl TypeNormalization {
    ...
    fn nmx_topic_mappings() -> TopicAwareTypeRenameTransform {
        ...
        // nmx.msg.LowdimData → robocodec.msg.* based on topic
        mapping.add_mapping(
            "/lowdim/joint",
            "nmx.msg.LowdimData",
            "robocodec.msg.JointStates",
        );
        mapping.add_mapping(
            "/lowdim/tcp",
            "nmx.msg.LowdimData",
            "robocodec.msg.eef_pose",
        );
        mapping.add_mapping(
            "/lowdim/ee_state",
            "nmx.msg.LowdimData",
            "robocodec.msg.ee_state",
        );
        mapping.add_mapping(
            "/lowdim/airexo_joint",
            "nmx.msg.LowdimData",
            "robocodec.msg.airexo_joint",
        );
        mapping.add_mapping(
            "/camera/intrinsic/camid_1",
            "nmx.msg.LowdimData",
            "robocodec.msg.camid_1_intrinsic",
        );
    ...
    fn global_type_mappings() -> TypeRenameTransform {
        ...
        // genie_msgs/* → robocodec.msg/* or ROS standard types
        mapping.add_mapping("genie_msgs/msg/ArmState", "robocodec.msg.ArmState");
        mapping.add_mapping(
            "genie_msgs/msg/BatteryStatus",
            "sensor_msgs.msg.BatteryState",
        );
        mapping.add_mapping("genie_msgs/msg/EndState", "robocodec.msg.EndEffectorState");
        mapping.add_mapping("genie_msgs/msg/FaultStatus", "robocodec.msg.FaultStatus");
        mapping.add_mapping("genie_msgs/msg/HeadState", "robocodec.msg.HeadState");
        mapping.add_mapping(
            "genie_msgs/msg/PeriStatus",
            "robocodec.msg.PeripheralStatus",
        );
        mapping.add_mapping("genie_msgs/msg/Position", "geometry_msgs.msg.Pose");
        mapping.add_mapping("genie_msgs/msg/PublicFaultMsg", "robocodec.msg.FaultStatus");
        mapping.add_mapping("genie_msgs/msg/SceneStatus", "robocodec.msg.SceneStatus");
        mapping.add_mapping("genie_msgs/msg/WaistState", "robocodec.msg.TorsoState");
        mapping.add_mapping(
            "genie_msgs/msg/WholeBodyStatus",
            "robocodec.msg.WholeBodyStatus",
        );

        // kuovo_msgs → robocodec.msg
        mapping.add_mapping("kuavo_msgs/sensorsData", "robocodec.msg.SensorsData");

        // upperlimb → robocodec.msg
        mapping.add_mapping("upperlimb/Pose", "robocodec.msg.EndEffectorPose");
