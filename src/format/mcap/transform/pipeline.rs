...
/// Transformation pipeline that applies multiple transforms in sequence.
///
...
///
/// ```ignore
/// use robocodec::transform::{TransformPipeline, TopicRenameTransform, TypeRenameTransform};
///
...
/// let (topic, type_name, schema) = pipeline.transform_channel(&channel);
/// ```
