...
///
/// Represents a pattern like "genie_msgs/msg/*" -> "robocodec_msgs/msg/*"
...
struct NamespaceRule {
    ...
    /// The target prefix (e.g., "robocodec_msgs/msg/")
...
struct NamespaceRewriteStrategy {
    ...
    /// IDL format mappings (e.g., "genie_msgs::msg::" -> "robocodec_msgs::msg::")
    idl_mappings: Vec<(String, String)>,
    /// Dot-notation for schemas (e.g., "genie_msgs.msg." -> "robocodec_msgs.msg.")
    dot_mappings: Vec<(String, String)>,
    /// Module declaration rewrite (e.g., "module genie_msgs {" -> "module robocodec_msgs {")
