...
use crate::formats::mcap::parallel::ParallelMcapReader;
...
impl<'a> RawMessageIter<'a> {
    ...
    pub fn into_stream(&self) -> Result<RawMessageStream<'a>> {
...
impl<'a> DecodedMessageIter<'a> {
    ...
    pub fn into_stream(&self) -> Result<DecodedMessageStream<'a>> {
...
impl<'a> DecodedMessageWithTimestampIter<'a> {
    ...
    pub fn into_stream(&self) -> Result<DecodedMessageWithTimestampStream<'a>> {
