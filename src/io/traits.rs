...
///
/// let reader = McapFormat::open("data.mcap")?;
/// let (sender, receiver) = bounded(32);
///
/// // Spawn reader thread
/// std::thread::spawn(move || {
///     let stats = reader.read_parallel(robocodec::io::traits::ParallelReaderConfig::default(), sender).unwrap();
...
pub trait ParallelReader: FormatReader {
    ...
    /// and sends MessageChunk objects through the provided channel. The channel
    ...
    fn read_parallel(
        ...
        sender: crossbeam_channel::Sender<crate::pipeline::types::chunk::MessageChunk<'static>>,
