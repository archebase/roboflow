...
use super::bag_parser::{BagChunkInfo, BagConnection, BagParser};
...
impl BagFormat {
    ...
    pub fn create_writer<P: AsRef<Path>>(
        ...
        Err(CodecError::unsupported(
            "BAG writer not yet implemented in unified I/O layer. Use format::writer::BagWriter directly.",
        ))
    }
}
...
pub struct BagRawIter<'a> {
    ...
    current_messages: Vec<super::bag_parser::BagMessageData>,
