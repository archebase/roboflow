...
impl CameraParamCollector {
    ...
    pub fn extract_from_mcap(
        &mut self,
        reader: &crate::format::McapReader,
    ...
    fn get_nested_string(&self, msg: &crate::DecodedMessage, path: &[&str]) -> Option<String> {
        let mut current = msg;
    ...
    fn get_nested_struct<'a>(
        &self,
        msg: &'a crate::DecodedMessage,
        path: &[&str],
    ) -> Option<&'a crate::DecodedMessage> {
        let mut current = msg;
    ...
    fn get_numeric_array(&self, msg: &crate::DecodedMessage, path: &[&str]) -> Option<Vec<f64>> {
        let mut current = msg;
    ...
    fn get_f64(&self, msg: &crate::DecodedMessage, path: &[&str]) -> Option<f64> {
        let mut current = msg;
    ...
    fn get_u32(&self, msg: &crate::DecodedMessage, path: &[&str]) -> Option<u32> {
        let mut current = msg;
