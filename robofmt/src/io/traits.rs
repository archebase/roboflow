...
///
/// ```no_run
/// use robofmt::io::traits::FormatReader;
///
...
///
/// ```no_run
/// use robofmt::io::traits::FormatWriter;
/// use robofmt::io::metadata::RawMessage;
///
...
/// use robofmt::io::traits::ParallelReader;
...
/// //     let config = robofmt::io::traits::ParallelReaderConfig::default();
